...
//TIPICAL VALUES
//-	Varianza longitudinal del l�ser sick detectando balizas reflectantes: 1.355x10-4 m^2
//Varianza angular del l�ser sick detectando balizas reflectantes : 3.08x10 - 4 rad ^ 2
//Varianza longitudinal del l�ser sick detectando objetos : 9.0x10 - 6 m ^ 2
//Varianza en avance longitudinal de la odometr�a : 1.347x10 - 3 m ^ 2
//Varianza en avance angular de la odometr�a : 3.68x10 - 4 rad ^ 2
